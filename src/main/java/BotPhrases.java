...
//        put("добрый вечер", "hello");
        ...
        put("роутер", "router");
        put("перезагрузить\\s.*роутер", "router");
        put("перезагрузка\\s.*роутера", "router");
        put("выключить\\s.*роутер", "router");
        //findRouter
    ...
    final Map<String, String> ANSWERS_BY_KEYS = new HashMap<String, String>() {{
        ...
        put("no", "Подскажите, что мне сделать, всё ещё ничего не работает?");
        put("bye", "До свидания. Всего вам доброго");
        ...
        put("restart", "Подскажите, куда мне нужно нажать?");
        ...
        put("internetSettings", "Нажала на него, там написано, подключение защищено, подключено и кнопка отключиться. " +
